...
As we have seen a bit earlier in [combinational-logic-design](../combinational-logic-design/ "mention"). The outputs of sequential logic depend on both current and prior input values. Hence, sequential has **memory**.
